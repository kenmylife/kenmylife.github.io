...
function disapear(n) {
  ...
  switch (n) {
    case 1:
      ...
      game.stake =
        document.getElementById("bet1").value * game.bet.bet2 + game.bet.bet;
      break;
    case 2:
      document.getElementById("tryp2c").style.display = "none";
      game.stake =
        document.getElementById("bet2").value * game.bet.bet2 + game.bet.bet;
      break;
    case 3:
      document.getElementById("tryp3c").style.display = "none";
      game.stake =
        document.getElementById("bet3").value * game.bet.bet2 + game.bet.bet;
      break;
    case 4:
      document.getElementById("tryp4c").style.display = "none";
      game.stake =
        document.getElementById("bet4").value * game.bet.bet2 + game.bet.bet;
      break;
    case 5:
      document.getElementById("tryp5c").style.display = "none";
      game.stake =
        document.getElementById("bet5").value * game.bet.bet2 + game.bet.bet;
      break;
    case 6:
      document.getElementById("tryp6c").style.display = "none";
      game.stake =
        document.getElementById("bet6").value * game.bet.bet2 + game.bet.bet;
      break;
    case 7:
      document.getElementById("tryp7c").style.display = "none";
      game.stake =
        document.getElementById("bet7").value * game.bet.bet2 + game.bet.bet;
      break;
    case 8:
      document.getElementById("tryp8c").style.display = "none";
      game.stake =
        document.getElementById("bet8").value * game.bet.bet2 + game.bet.bet;
      break;
    case 9:
      document.getElementById("tryp9c").style.display = "none";
      game.stake =
        document.getElementById("bet9").value * game.bet.bet2 + game.bet.bet;
      break;
    case 10:
      document.getElementById("tryp10c").style.display = "none";
      game.stake =
        document.getElementById("bet10").value * game.bet.bet2 + game.bet.bet;
      break;
    case 11:
      document.getElementById("tryp11c").style.display = "none";
      game.stake =
        document.getElementById("bet11").value * game.bet.bet2 + game.bet.bet;
      break;
    case 12:
      document.getElementById("tryp12c").style.display = "none";
      game.stake =
        document.getElementById("bet12").value * game.bet.bet2 + game.bet.bet;
      break;
    default:
  }
}
